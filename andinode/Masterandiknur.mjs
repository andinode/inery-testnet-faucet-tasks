...
// Call all function
async function TransactioninDetail(data){
  await CreateTxhashdetail(data)
  await ReadTXhashDetail(data)
  await UpdateTXhashDetail(data)
  await DestroyTXhashDetail(data)
}
